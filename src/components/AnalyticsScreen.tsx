  ...
  return (
    <div className="space-y-6 pb-24 max-w-2xl mx-auto">
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-2 shadow-sm">
        ...
        <h2 className="text-xl font-bold text-white tracking-tight">Ваш прогрес досягнень</h2>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 space-y-1">
          <div className="text-xs text-slate-400 flex items-center gap-1.5">
            ...
            <span>Законтрактований час</span>
          </div>
          <div className="text-2xl font-bold text-white">
            {Math.floor(totalMinutesSaved / 60)}г {totalMinutesSaved % 60}хв
          </div>
        </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-5 space-y-3">
        ...
        <div className="space-y-2 text-xs">
          ...
          <div className="flex justify-between items-center text-slate-300">
            <span>Стандартний процес (Medium Energy):</span>
